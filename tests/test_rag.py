...
class TestReranker:
  ...
  @pytest.mark.slow
  def test_rerank_documents_returns_sorted(
    self,
    mock_rerank_passages: list[dict]
  ) -> None:
...
class TestAskQuestion:
  ...
  def test_ask_question_no_vectorstore_raises(
    self,
    mock_chat_messages: list[dict]
  ) -> None:

...
def ask_question(question: str, messages: list[dict], vectorstore, model_name: str | None = None, temperature: float = 0.3, language: str = "id") -> tuple[Iterator[str], list[dict[str, Any]]]:
  """
  ...
  sources = [
    {"metadata": res["meta"], "page_content": res["text"]}
